...
export const metadata = {
  title: 'Home',
  description: '👋 Welcome to My Portfolio! 🚀 I\'m a dedicated Front- End Developer who turns ideas into captivating web experiences.With a blend of creativity and code, I craft user - friendly interfaces using HTML, CSS, and JavaScript.Explore my projects that showcase my passion htmlFor design and innovation.Let\'s build the web of tomorrow, today!'
}
